...
def compute_map(ranks, gnd,idlist, kappas=[],kqq=10):
  """
...
def compute_map_and_print(dataset, ranks, gnd,idlist, kappas=[1, 5, 10],qjnd=-1):
  # old evaluation protocol
  if dataset.startswith('oxford5k') or dataset.startswith('paris6k'):
    map, aps, _, _ = compute_map(ranks, gnd,idlist,kappas=kappas,kqq=qjnd)
