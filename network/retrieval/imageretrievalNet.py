...
from graph.pooling import MAC, SPoC, GeM, GeMmp, RMAC, Rpool
from graph.normalization import L2N, PowerLaw
from datasets.imageListDateset import ImagesFromList
from datasets.readSfmData import get_data_root
...
def init_network(params):
    ...
    if pretrained and architecture in FEATURES:
        ...
        model_dir = '/home/shibaorong/cnnimageretrieval-pytorch/data/networks'
